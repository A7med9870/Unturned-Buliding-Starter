...
class VIEW3D_PT_unturned_settings(Panel):
    ...
    def draw(self, context):
        ...
        #layout.prop(preferences, "show_Export_panel")
        layout.prop(preferences, "show_Extra_objects_panel")
        layout.prop(preferences, "show_Floors_objects_panel")
        layout.prop(preferences, "show_roofs_objects_panel")
        layout.prop(preferences, "show_doors_objects_panel")
        layout.prop(preferences, "show_windows_objects_panel")
        layout.prop(preferences, "show_ramparts_objects_panel")
        layout.prop(preferences, "show_stairs_objects_panel")
...
class VIEW3D_PT_unturned_settings(Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(preferences, "Geo_test")
        row = layout.row()
        if preferences.show_Export_panel:
